...
extension UIViewController {
     ...
     *
     */
    func presentRouter(_ router: BaseRouter, presentationStyle: UIModalPresentationStyle, modalPresentationCapturesStatusBarAppearance: Bool = false, animated: Bool = true, completion: (() -> Void)? = nil) {
    ...
    func dismissAllViewController(_ router: BaseRouter, animated: Bool = true) {
